...
GOOD_MOMENTUM = PairSnapshot(
    ...
    pair_created_at_ms=1_700_000_000_000,  # ~2023 — well over 24h
    dex_id="raydium",
)

# Fails liquidity gate
...
FRESH_LAUNCH = PairSnapshot(
    ...
    pair_created_at_ms=int(__import__("time").time() * 1000) - 3_600_000,  # 1h old
)

# No momentum — flat price, normal volume (valid base58 mint for telegram regex tests)
